...
from ..gemma_inference import detect_hardware, get_gemma_inference_options
...
class LocalProvider:
    ...
    def _build_payload(
        ...
        if self._model == "gemma-4-e4b":
            os_platform, hardware_type = detect_hardware()
            gemma_opts = get_gemma_inference_options(os_platform, hardware_type)
            payload["options"] = gemma_opts
