...
_MSG = {
    "en": {
        ...
        "redis_guide":      "\nChoose how to start Redis:",
        "redis_opt1":       "  1) Start automatically  (docker-compose up -d redis)",
        ...
        "redis_invalid":    "  Please enter 1, 2, or 3.",
    },
    "ko": {
        "lang_prompt":      "Select language / 언어를 선택하세요  [1] English  [2] 한국어 : ",
        ...
        "redis_guide":      "\nRedis 실행 방법을 선택하세요:",
        "redis_opt1":       "  1) 자동으로 시작  (docker-compose up -d redis)",
...
def _check_redis_or_guide() -> None:
    ...
    while True:
        ...
        print()
        choice = input(msg["redis_select"]).strip()
