...
async def test_install_rejects_path_traversal_name():
    ...
    with patch("agents.cassiopeia_agent.marketplace_handler.socket.gethostbyname", return_value="93.184.216.34"):
        with patch("agents.cassiopeia_agent.marketplace_handler.httpx.AsyncClient") as mock_client_cls:
