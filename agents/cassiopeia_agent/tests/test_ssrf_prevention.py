...
from agents.cassiopeia_agent.marketplace_handler import MarketplaceHandler, _validate_marketplace_url
...
async def test_ssrf_dns_rebinding_prevention():
    ...
    with patch("agents.cassiopeia_agent.marketplace_handler.socket.gethostbyname") as mock_dns:
        mock_dns.return_value = "93.184.216.34" # example.com IP
        
        with patch("agents.cassiopeia_agent.marketplace_handler.httpx.AsyncClient.get") as mock_get:
